...
const Navbar = () => {
    ...
    return (
        <div>
            ...
            <div>
                <img src="https://upload.wikimedia.org/wikipedia/commons/2/2f/Mr.Pizza_logo.JPG" width={'55px'} height={'55px'} />
            </div>
                <a className="navbar-brand ml-3" href="/"><small>MR.</small> PIZZA </a>
